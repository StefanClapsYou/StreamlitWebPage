...
st.write("I am a student in proggress in learning python witht hte goal of being a web dezigner")
...
with st.container():
    ...
    with left_column:
        ...
        st.write(
            """
            Hello! So I don't really have a job YET. I am still learning how to use python for web dezining!
            Heres some stuff I do on the free time: I play soccer/football I play the guitar
            I study with cisco academy with proffessor Ardi, learning python essentials, etc!
...
with st.container():
    ...
    with text_column:
        ...
        st.write(
            """
            Watch me react to Dhar Mann's propably most cringe video so far.
            No hate to him just the whole purpose of his channel is to change lives while thet video does the complete opposite...
